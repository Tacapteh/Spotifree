...
import { Download, Play, Pause, Trash2, ExternalLink, Clock, HardDrive, AlertTriangle, CheckCircle } from 'lucide-react';
  ...
  const handlePlayTrack = async (track) => {
    try {
      if (currentlyPlaying === track.id) {
        ...
        // You would typically create an audio element or use your existing player
        // For now, we'll just show that it's "playing"
        toast({
  ...
  return (
    <div className="h-full bg-black text-white flex flex-col">
        ...
        <div className="mb-6 p-4 bg-yellow-900/20 border border-yellow-500/20 rounded-lg">
          <div className="flex items-start gap-2">
            ...
            <div className="text-sm">
              <p className="font-medium text-yellow-500 mb-1">Avertissement Important</p>
              <p className="text-yellow-200">
                Assurez-vous de respecter les conditions d'utilisation de YouTube et les lois sur le droit d'auteur. 
                Utilisez cette fonctionnalité uniquement pour du contenu que vous possédez ou qui est dans le domaine public.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 overflow-y-auto p-6">
        {/* Video Info Preview */}
        {videoInfo && (
          <Card className="mb-6 p-4 bg-gray-900 border-gray-700">
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-400 text-sm mb-2">Par: {videoInfo.uploader}</p>
        ...
        <div>
          <h2 className="text-xl font-semibold mb-4 flex items-center gap-2">
            ...
            Téléchargements ({downloadedTracks.length})
          </h2>
